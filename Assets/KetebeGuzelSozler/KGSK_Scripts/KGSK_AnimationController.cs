...
{
    public class KGSK_AnimationController : MonoBehaviour
    {
        ...
        {
            if (string.IsNullOrEmpty(animationSoundName) || KGSK_AudioManager.instance == null)
                return;
            ...
            {
                if (isSoundLoop)
                    KGSK_AudioManager.instance.PlayClip(animationSoundName, true);
                else
                    KGSK_AudioManager.instance.PlayClip(animationSoundName);
        ...
        void StopAnimationSound()
        {
            ...
            if (isPlayingSound)
            {
                KGSK_AudioManager.instance.Stop(animationSoundName);
