...
{
    public class KGSK_KetebeUIManager : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            musicController = KGSK_AudioManager.instance._bgAudioSource;
            readingSounds = KGSK_AudioManager.instance._storytellingSource;
        ...
        private void Update()
        {
            ...
            if (isSound)
            {
                ...
                KGSK_AudioManager.instance._bgAudioSource.mute = true;
                KGSK_AudioManager.instance._singleAudioSource.mute = true;
                PlayerPrefs.SetInt("MusicData", 1);
            }
            else
            {
                soundButton.GetComponent<Image>().sprite = soundSprites[0];
                KGSK_AudioManager.instance._bgAudioSource.mute = false;
                KGSK_AudioManager.instance._singleAudioSource.mute = false;
            ...
            if (isSoundEffect)
            {
                ...
                KGSK_AudioManager.instance.MuteAllLoopingSounds(true);
                PlayerPrefs.SetInt("SoundData", 1);
            }
            else
            {
                soundEffectButton.GetComponent<Image>().sprite = soundEffectSprites[0];
                KGSK_AudioManager.instance.MuteAllLoopingSounds(false);
            ...
            if (isReadingSound)
            {
                ...
                KGSK_AudioManager.instance._storytellingSource.mute = true;
                PlayerPrefs.SetInt("ReadingData", 1);
            }
            else
            {
                readingButton.GetComponent<Image>().sprite = readingSprites[0];
                KGSK_AudioManager.instance._storytellingSource.mute = false;
        ...
        {
            KGSK_AudioManager.instance.buttonClick.Play();
        }
        ...
        private void SoundEffectFindAudioSystem()
        {
            ...
            soundEffects.Remove(KGSK_AudioManager.instance._bgAudioSource);
            soundEffects.Remove(KGSK_AudioManager.instance._storytellingSource);
        }
