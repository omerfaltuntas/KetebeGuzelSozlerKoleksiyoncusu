...
{
    public class KGSK_PinchToZoomCamera : MonoBehaviour
    {
        public static KGSK_PinchToZoomCamera instance;
        ...
        Vector3 _touchStart;
        private KGSK_ImageSwiper _KGSK_ImageSwiper;

        private void Start()
        {
            instance = this;
            _KGSK_ImageSwiper = GetComponent<KGSK_ImageSwiper>();
        ...
        public void ZoomActiverDeactiver()
        {
            ...
            _KGSK_ImageSwiper.enabled = !_KGSK_ImageSwiper.enabled;

            GameObject myObject = _KGSK_ImageSwiper.pages[KGSK_ImageSwiper.choosenPage];
