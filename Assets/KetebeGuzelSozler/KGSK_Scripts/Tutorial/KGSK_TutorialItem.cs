...
{
    public class KGSK_TutorialItem : MonoBehaviour
    {
        ...
        public void Show(Action onClicked)
        {
            ...
            {
                KGSK_TutorialClickReceiver receiver = targetObject.GetComponent<KGSK_TutorialClickReceiver>();
                if (receiver == null)
                    receiver = targetObject.AddComponent<KGSK_TutorialClickReceiver>();
