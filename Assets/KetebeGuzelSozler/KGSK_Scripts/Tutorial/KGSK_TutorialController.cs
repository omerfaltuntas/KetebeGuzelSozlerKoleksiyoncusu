...
{
    public class KGSK_TutorialController : MonoBehaviour
    {
        private List<KGSK_TutorialItem> tutorialItems = new List<KGSK_TutorialItem>();
        ...
        IEnumerator DelayedInit()
        {
            ...
            foreach (var item in tutorialItems)
            {
                ...
                {
                    var receiver = item.targetObject.GetComponent<KGSK_TutorialClickReceiver>();
                    if (receiver == null)
                        receiver = item.targetObject.AddComponent<KGSK_TutorialClickReceiver>();
