...
{
    public class KGSK_ImageSwiper : MonoBehaviour
    {
        ...
        void LateUpdate()
        {
            ...
            { // sol tıklandı mı kontrol ediliyor
                ...
                { // en az bir nesne bulunduysa
                    ...
                    {
                        if (hit.collider.GetComponent<KGSK_Types>() != null)
                        {
                            if (hit.collider.GetComponent<KGSK_Types>().KGSKPage != Pages.KGSKPages)
                            {
                                isDraggable = false;
                    ...
                    { // tüm nesneleri döngüye sokuyoruz
                        ...
                        if (hit.collider.GetComponent<KGSK_Types>() != null)
                        {
                            if (hits[0].collider.GetComponent<KGSK_Types>() != null)
                            {

                                if (hit.collider.GetComponent<KGSK_Types>().KGSKPage == Pages.KGSKPages && hits[0].collider.GetComponent<KGSK_Types>().KGSKPage == Pages.KGSKPages && isDraggable)
                                {
        ...
        {
            //MagazineManager.instance.BackHome();
        }
    }
}
