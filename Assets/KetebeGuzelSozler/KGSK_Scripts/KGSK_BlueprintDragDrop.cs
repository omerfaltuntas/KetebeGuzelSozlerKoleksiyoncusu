...
{
    public class KGSK_BlueprintDragDrop : MonoBehaviour
    {
        [Header("Distance")]
        [SerializeField] private float distanceMeasurement = 2f;

        [Header("Puzzle Elements")]
        [SerializeField] private List<KGSK_Slot> slots = new List<KGSK_Slot>();
        ...
        private void OnMouseUp()
        {
            if (Input.GetMouseButtonUp(0))
            {
                ...
                foreach (KGSK_Slot slot in slots)
                {
        ...
        private void OnCorrectPlacement(KGSK_Slot puzzleSlot)
        {
