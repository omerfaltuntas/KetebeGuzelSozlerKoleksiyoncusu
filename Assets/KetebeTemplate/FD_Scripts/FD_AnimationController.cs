...
{
    public class FD_AnimationController : MonoBehaviour
    {
        ...
        {
            if (string.IsNullOrEmpty(animationSoundName) || FD_AudioManager.instance == null)
                return;
            ...
            {
                if (isSoundLoop)
                    FD_AudioManager.instance.PlayClip(animationSoundName, true);
                else
                    FD_AudioManager.instance.PlayClip(animationSoundName);
        ...
        void StopAnimationSound()
        {
            ...
            if (isPlayingSound)
            {
                FD_AudioManager.instance.Stop(animationSoundName);
