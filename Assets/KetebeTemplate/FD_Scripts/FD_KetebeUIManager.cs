...
{
    public class FD_KetebeUIManager : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            musicController = FD_AudioManager.instance._bgAudioSource;
            readingSounds = FD_AudioManager.instance._storytellingSource;
        ...
        private void Update()
        {
            ...
            if (isSound)
            {
                ...
                FD_AudioManager.instance._bgAudioSource.mute = true;
                FD_AudioManager.instance._singleAudioSource.mute = true;
                PlayerPrefs.SetInt("MusicData", 1);
            }
            else
            {
                soundButton.GetComponent<Image>().sprite = soundSprites[0];
                FD_AudioManager.instance._bgAudioSource.mute = false;
                FD_AudioManager.instance._singleAudioSource.mute = false;
            ...
            if (isSoundEffect)
            {
                ...
                FD_AudioManager.instance.MuteAllLoopingSounds(true);
                PlayerPrefs.SetInt("SoundData", 1);
            }
            else
            {
                soundEffectButton.GetComponent<Image>().sprite = soundEffectSprites[0];
                FD_AudioManager.instance.MuteAllLoopingSounds(false);
            ...
            if (isReadingSound)
            {
                ...
                FD_AudioManager.instance._storytellingSource.mute = true;
                PlayerPrefs.SetInt("ReadingData", 1);
            }
            else
            {
                readingButton.GetComponent<Image>().sprite = readingSprites[0];
                FD_AudioManager.instance._storytellingSource.mute = false;
        ...
        {
            FD_AudioManager.instance.buttonClick.Play();
        }
        ...
        private void SoundEffectFindAudioSystem()
        {
            ...
            soundEffects.Remove(FD_AudioManager.instance._bgAudioSource);
            soundEffects.Remove(FD_AudioManager.instance._storytellingSource);
        }
