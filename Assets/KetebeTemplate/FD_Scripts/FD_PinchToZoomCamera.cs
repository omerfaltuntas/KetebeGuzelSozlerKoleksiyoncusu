...
{
    public class FD_PinchToZoomCamera : MonoBehaviour
    {
        public static FD_PinchToZoomCamera instance;
        ...
        Vector3 _touchStart;
        private FD_ImageSwiper _FD_ImageSwiper;

        private void Start()
        {
            instance = this;
            _FD_ImageSwiper = GetComponent<FD_ImageSwiper>();
        ...
        public void ZoomActiverDeactiver()
        {
            ...
            _FD_ImageSwiper.enabled = !_FD_ImageSwiper.enabled;

            GameObject myObject = _FD_ImageSwiper.pages[FD_ImageSwiper.choosenPage];
